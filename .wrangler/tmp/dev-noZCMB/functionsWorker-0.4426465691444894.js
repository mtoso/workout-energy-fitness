...
// .wrangler/tmp/pages-UjFQVr/functionsWorker-0.4426465691444894.mjs
...
__name2(checkBlake2Opts, "checkBlake2Opts");
var _BLAKE2 = class {
  static {
    __name(this, "_BLAKE2");
  }
  static {
    __name2(this, "_BLAKE2");
  }
  buffer;
  buffer32;
  finished = false;
...
var abytesOrZero = /* @__PURE__ */ __name2((buf, errorTitle = "") => {
  if (buf === void 0)
...
__name2(argon2Output, "argon2Output");
...
__name2(processBlock, "processBlock");
...
__name2(argon2, "argon2");
var argon2id = /* @__PURE__ */ __name2((password, salt, opts) => argon2(AT.Argon2id, password, salt, opts), "argon2id");
var textEncoder = new TextEncoder();
var equalBytes = /* @__PURE__ */ __name2((left, right) => {
...
var toBase64Url = /* @__PURE__ */ __name2((bytes) => btoa(String.fromCharCode(...bytes)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=+$/g, ""), "toBase64Url");
var fromBase64Url = /* @__PURE__ */ __name2((input) => {
  const normalized = input.replace(/-/g, "+").replace(/_/g, "/");
  const padded = normalized + "=".repeat((4 - normalized.length % 4) % 4);
  const binary = atob(padded);
  return Uint8Array.from(binary, (char) => char.charCodeAt(0));
}, "fromBase64Url");
var randomToken = /* @__PURE__ */ __name2((byteLength = 32) => {
  const bytes = new Uint8Array(byteLength);
  crypto.getRandomValues(bytes);
  return toBase64Url(bytes);
}, "randomToken");
var sha256Hex = /* @__PURE__ */ __name2(async (value) => {
...
var hashPassword = /* @__PURE__ */ __name2((password) => {
...
var parseArgon2Hash = /* @__PURE__ */ __name2((encoded) => {
...
var verifyPassword = /* @__PURE__ */ __name2((password, encodedHash) => {
...
var displayNameFromEmail = /* @__PURE__ */ __name2((email) => email.split("@")[0].split(/[._-]/).filter(Boolean).map((chunk) => chunk.charAt(0).toUpperCase() + chunk.slice(1)).join(" "), "displayNameFromEmail");
var DEFAULT_SESSION_COOKIE_NAME = "wef_session";
var DEFAULT_SESSION_TTL_HOURS = 24 * 30;
var normalizeCookieString = /* @__PURE__ */ __name2((cookieString) => cookieString ?? "", "normalizeCookieString");
var parseCookieValue = /* @__PURE__ */ __name2((request, name) => {
...
var toAuthUser = /* @__PURE__ */ __name2((row) => ({
  id: row.id,
  email: row.email,
...
var getSessionCookieName = /* @__PURE__ */ __name2((env) => env.SESSION_COOKIE_NAME || DEFAULT_SESSION_COOKIE_NAME, "getSessionCookieName");
var getSessionMaxAgeSeconds = /* @__PURE__ */ __name2((env) => {
...
var buildSessionCookie = /* @__PURE__ */ __name2((request, env, sessionToken, maxAgeSeconds) => {
...
var clearSessionCookie = /* @__PURE__ */ __name2((request, env) => {
  const requestUrl = new URL(request.url);
  const cookieName = getSessionCookieName(env);
  const secure = requestUrl.protocol === "https:";
  const parts = [
...
var getAuthSession = /* @__PURE__ */ __name2(async (request, env) => {
  const cookieName = getSessionCookieName(env);
...
var issueSession = /* @__PURE__ */ __name2(async (request, env, userId) => {
...
var revokeSession = /* @__PURE__ */ __name2(async (request, env) => {
...
var json = /* @__PURE__ */ __name2((payload, status = 200, headers) => new Response(JSON.stringify(payload), {
  status,
  headers: {
...
var fail = /* @__PURE__ */ __name2((status, error, message2, details) => json({ error, message: message2, details }, status), "fail");
var requireAuth = /* @__PURE__ */ __name2(async (request, env) => {
  const session = await getAuthSession(request, env);
  if (!session) return fail(401, "unauthorized", "Autenticazione richiesta.");
  return session;
}, "requireAuth");
var requireManager = /* @__PURE__ */ __name2(async (request, env) => {
...
var requireAdmin = /* @__PURE__ */ __name2(async (request, env) => {
  const auth = await requireAuth(request, env);
  if (auth instanceof Response) return auth;
...
var loadManagedUser = /* @__PURE__ */ __name2(async (env, userId) => env.DB.prepare(
  `
      SELECT
        id,
        email,
...
var requireManagedUserAccess = /* @__PURE__ */ __name2(async (auth, env, userId) => {
...
var readJson = /* @__PURE__ */ __name2(async (request) => {
  try {
...
var parseNullable = /* @__PURE__ */ __name2((value) => {
  if (value === void 0 || value === null) return null;
  const asString = String(value).trim();
  return asString ? asString : null;
}, "parseNullable");
var formatDateLabel = /* @__PURE__ */ __name2((isoValue) => {
...
var loadPlanRow = /* @__PURE__ */ __name2(async (env, planId, userId) => env.DB.prepare(
  `
...
var validateAdminWorkoutPlanInput = /* @__PURE__ */ __name2((payload) => {
...
var listWorkoutPlansForUser = /* @__PURE__ */ __name2(async (env, userId) => {
...
var getWorkoutPlanById = /* @__PURE__ */ __name2(async (env, userId, planId) => {
...
var clearWorkoutPlanStructure = /* @__PURE__ */ __name2(async (env, planId) => {
...
var saveWorkoutPlanById = /* @__PURE__ */ __name2(async (env, userId, planId, actorUserId, input) => {
...
var createWorkoutPlanForUser = /* @__PURE__ */ __name2(async (env, userId, actorUserId, copyFromPlanId) => {
...
var activateWorkoutPlanForUser = /* @__PURE__ */ __name2(async (env, userId, planId) => {
  const existingPlan = await loadPlanRow(env, planId, userId);
  if (!existingPlan) {
    return fail(404, "plan_not_found", "Scheda non trovata.");
  }
...
var getCurrentFlattenedWorkoutPlanForUser = /* @__PURE__ */ __name2(async (env, userId) => {
...
var onRequestGet = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
  const userId = params.userId;
  const planId = params.planId;
...
var onRequestPut = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
  const userId = params.userId;
  const planId = params.planId;
...
var mapCoachSummary = /* @__PURE__ */ __name2((row) => ({
  id: row.id,
  email: row.email,
  fullName: row.full_name?.trim() || displayNameFromEmail(row.email),
  isAdmin: Boolean(row.is_admin),
...
var mapUserSummary = /* @__PURE__ */ __name2((row) => ({
  id: row.id,
  email: row.email,
  fullName: row.full_name?.trim() || displayNameFromEmail(row.email),
  userType: row.user_type,
...
var listVisibleUsers = /* @__PURE__ */ __name2(async (env, auth) => {
  const baseSelect = `
    SELECT
      u.id,
      u.email,
...
var listCoaches = /* @__PURE__ */ __name2(async (env) => {
...
var loadUserSummaryRow = /* @__PURE__ */ __name2(async (env, userId) => env.DB.prepare(
  `
      SELECT
        u.id,
        u.email,
...
var getManagedUserDetail = /* @__PURE__ */ __name2(async (env, auth, userId) => {
...
var assignCoachToClient = /* @__PURE__ */ __name2(async (env, clientUserId, coachUserId) => {
...
var createBodyCheckin = /* @__PURE__ */ __name2(async (env, auth, userId, payload) => {
  const targetUser = await requireManagedUserAccess(auth, env, userId);
  if (targetUser instanceof Response) return targetUser;
  await env.DB.prepare(
    `
...
var onRequestPost2 = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
  const userId = params.userId;
  if (!userId) {
...
var onRequestPut2 = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
...
var onRequestGet2 = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
  const userId = params.userId;
  if (!userId) {
...
var onRequestGet3 = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
  const userId = params.userId;
...
var onRequestPost3 = /* @__PURE__ */ __name2(async ({ request, env, params }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
  const userId = params.userId;
  if (!userId) return fail(400, "invalid_user", "L'identificativo utente \xE8 obbligatorio.");
...
var findUserByEmail = /* @__PURE__ */ __name2(async (env, email) => env.DB.prepare(
  `
      SELECT
        id,
        email,
...
var getAuthUserById = /* @__PURE__ */ __name2(async (env, userId) => {
  const row = await env.DB.prepare(
    `
      SELECT
        id,
...
var findInvitedUserByToken = /* @__PURE__ */ __name2(async (env, inviteToken) => {
...
var createInvitedUser = /* @__PURE__ */ __name2(async (env, input) => {
...
var activateInvitedUser = /* @__PURE__ */ __name2(async (env, invitedUser, email, identity, password) => {
...
var attachIdentityToUser = /* @__PURE__ */ __name2(async (env, userId, provider, providerSubject, emailVerified) => {
  try {
    await env.DB.prepare(
      `
        INSERT INTO user_identities (
...
var getUserByIdentity = /* @__PURE__ */ __name2(async (env, provider, providerSubject) => env.DB.prepare(
  `
      SELECT
        u.id,
        u.email,
...
var touchIdentityLogin = /* @__PURE__ */ __name2(async (env, provider, providerSubject, userId) => {
  await env.DB.batch([
    env.DB.prepare(
      `
...
var ensureString = /* @__PURE__ */ __name2((value) => typeof value === "string" && value.trim() ? value.trim() : null, "ensureString");
var isAuthoritativeGoogleEmail = /* @__PURE__ */ __name2((email, hostedDomain) => email.endsWith("@gmail.com") || hostedDomain !== null, "isAuthoritativeGoogleEmail");
var verifyGoogleToken = /* @__PURE__ */ __name2(async (idToken, env) => {
...
var accountStatusError = /* @__PURE__ */ __name2((status) => {
  if (status === "invited") {
    return fail(403, "account_not_activated", "Completa l'attivazione dell'invito prima di accedere.");
  }
  if (status === "disabled") {
...
var loginWithGoogle = /* @__PURE__ */ __name2(async (request, env) => {
  const bodyOrResponse = await readJson(request);
  if (bodyOrResponse instanceof Response) return bodyOrResponse;
...
var onRequestPost5 = /* @__PURE__ */ __name2(async ({ request, env }) => loginWithGoogle(request, env), "onRequestPost");
...
var signupWithGoogle = /* @__PURE__ */ __name2(async (request, env) => {
  const bodyOrResponse = await readJson(request);
  if (bodyOrResponse instanceof Response) return bodyOrResponse;
  const inviteToken = (bodyOrResponse.inviteToken || "").trim();
  if (!inviteToken) {
...
var onRequestPost7 = /* @__PURE__ */ __name2(async ({ request, env }) => signupWithGoogle(request, env), "onRequestPost");
...
var buildInviteUrl = /* @__PURE__ */ __name2((request, env, inviteToken) => {
...
var onRequestGet5 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  const auth = await requireManager(request, env);
  if (auth instanceof Response) return auth;
...
var onRequestPost9 = /* @__PURE__ */ __name2(async ({ request, env }) => {
...
var onRequestGet6 = /* @__PURE__ */ __name2(async ({ request, env }) => {
...
var getWorkoutPlanForUser = /* @__PURE__ */ __name2(async (env, userId) => getCurrentFlattenedWorkoutPlanForUser(env, userId), "getWorkoutPlanForUser");
var onRequestGet7 = /* @__PURE__ */ __name2(async ({ request, env }) => {
  const auth = await requireAuth(request, env);
  if (auth instanceof Response) return auth;
...
// .wrangler/tmp/bundle-X7HNum/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-X7HNum/middleware-loader.entry.ts
...
*/
//# sourceMappingURL=functionsWorker-0.4426465691444894.js.map
