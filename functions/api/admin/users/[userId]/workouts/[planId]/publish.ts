import { fail, json, publishWorkoutPlanForUser, requireManagedUserAccess, requireManager } from '../_lib';
...
export const onRequestPost: PagesFunction<Env> = async ({ request, env, params }) => {
  ...
  const plan = await publishWorkoutPlanForUser(env, userId, planId);
